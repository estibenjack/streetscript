"""
Django settings for streetscript project.
...
# New generated SECRET_KEY in .env
...
ROOT_URLCONF = 'streetscript.urls'
...
WSGI_APPLICATION = 'streetscript.wsgi.application'
...
# override with DATABASE_URL if it exists (Render provides this in prod)
